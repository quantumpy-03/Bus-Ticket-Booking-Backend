...
# The string "False" is truthy in Python. This ensures it's a real boolean.
...
# For WhiteNoise, to enable compression and caching.
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# This is the directory where `collectstatic` will gather all static files
# for deployment. It should be an absolute path.
...
# Allow cookies/credentials for development when needed
